...
MagnificatOrgano = {
  \relative c {
    ...
    \partial 4 r4
    r8 r16 \mvTr d'[\fE-\soloE h8. d16] g,4 r
    r8 r16 h16[ g8. h16] e,4 r
    r8 r16 g[ e8. g16] c,8 r h r
    a r g r d'4 d\pE
    d d d r %5
    d d d r
    r8 r16 \mvTr d'[\fE-\tuttiE h8. d16] g,2
    g, r8 r16 h'[ g8. h16]
    e,1
    r8 r16 g[ e8. g16] c,4 h %10
    a g d'2
    g,2. r4
    \tempoMagnificatB \clef treble << {
      r2-\critnote r4 d'''
      d c h e
      e
    } \\ {
    ...
    f?4 f b, h
    c c c,2
    \clef "treble_8" d''^\critnote c
    h!4. h8 c4 \clef bass c~
    c b2 a4~ %55
    a g8 f c4 f
    c2 c,
    f8 f f' f e e e e
...
MagnificatBassFigures = \figuremode {
  ...
  <6 4>2 <5 3>
  <7>4 <6-> <7> <6>
  <7> <6>2 <8 6>4 \bassFigureExtendersOn
  <8> <8 6>2 <8 6!\!>4 %55
  <8 6!> \bassFigureExtendersOff <6 _->8 <8> r2
  <4!>2 <3>
  r <6>
  <_!>4 <6> r <6>
  <_!> <6> r2 %60
  r2 <6- _!>4 <6 5->
  <9 4->8 <8 3> r <7-> <6- _!>4 <6 5->
  r4 <7 5!> r2
  <6 5!> q
  <6 5> q %65
  <_!>2. <6>4
...
GloriaOrgano = {
  \relative c {
    ...
    c, c c
    c2.
    \clef bass r4 e,8.\f -\tweak TextScript.X-offset #2 -\tuttiE e16 ais,8. ais16
    h4 h r
    ...
    c4 h c
    d d,2
    \clef bass \mvTr g8.[\f-\tutti g16 g8. g16 g8. g16]
...
SicutEratBassFigures = \figuremode {
  ...
  <2>4 <\t> <2> <\t>
  r1
  r4 <5 3>2 \bassFigureExtendersOn q8 q \bassFigureExtendersOff %440
  <9>4 <8>2.
  <9>4 <8>2.
  <9>4 <8>2.
  r1*6 %449
